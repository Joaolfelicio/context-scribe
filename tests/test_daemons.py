...
async def test_run_daemon_tools(tool, provider_class, evaluator_class, bootstrap_func, daemon_mocks):
                ...
                with patch(f"context_scribe.main.{bootstrap_func}"):
                    ...
                    with patch("context_scribe.main.Live") as mock_live:
                        with patch("os._exit") as mock_exit:
                            ...
                            daemon_task = asyncio.create_task(run_daemon(tool, "~/.memory-bank"))
